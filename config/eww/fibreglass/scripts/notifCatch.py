...
log_file = os.path.expandvars("$HOME/.cache/eww/notifications.json")
cache_dir = os.path.expandvars("$HOME/.cache/eww/notifications_img")
...
class NotificationDaemon(dbus.service.Object):
    ...
    def save_popup(self, notification):
        ...
        active_popups[popup_id] = GLib.timeout_add_seconds(3, self.DismissPopup, popup_id)
